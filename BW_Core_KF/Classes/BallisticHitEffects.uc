class BallisticHitEffects extends KFMeleeHitEffect;
...
defaultproperties
{
	HitEffects(0)=(HitDecal=class'KnifeHitDirt',HitEffect=class'ROBulletHitRockEffect',HitSound=sound'KF_KnifeSnd.Knife_HitDefault')        // Default
