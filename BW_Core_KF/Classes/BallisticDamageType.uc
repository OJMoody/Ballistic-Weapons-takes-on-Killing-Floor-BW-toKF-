...
//=============================================================================
class BallisticDamageType extends WeaponDamageType config(BallisticFix);
...
var string							DamageIdent;		// The stats slot this damagetype fits into
																// Melee, Sidearm, SMG, Assault, Energy, Machinegun, Shotgun, Ordnance, Sniper, Streak, Grenade
